...
package org.puremvc.as3.multicore.core
{
	...
	public class View implements IView
	{
		...
		public function notifyObservers( notification:INotification ) : void
		{
			if( observerMap[ notification.getName() ] != null ) {
				...
				for (var i:Number = 0; i < observers_ref.length; i++) { 
					observer = observers_ref[ i ]  /*[IF-FLASH]*/ as IObserver;
					observers.push( observer );
				}
				
				// Notify Observers from the working array				
				for (i = 0; i < observers.length; i++) {
					observer = observers[ i ] /*[IF-FLASH]*/ as IObserver;
		...
		{
			return mediatorMap[ mediatorName ] /*[IF-FLASH]*/ as IMediator;
		}
		...
		public function removeMediator( mediatorName:String ) : IMediator
		{
			...
			var mediator:IMediator = mediatorMap[ mediatorName ] /*[IF-FLASH]*/as IMediator;
